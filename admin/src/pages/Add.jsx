...
const Add = ({token}) => {
    ...
    const [category, setCategory] = useState("OfficeWear");
    const [SubCategory, setSubCategory] = useState("Suits");
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3' >
        ...
        <div className='w-full'>
            ...
            <input onChange={(e)=> setName(e.target.value)} value={name} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Add product name here' required  />
        </div>
        ...
        <div className='flex flex-col sm:flex-row gap-2w-full sm:gap-8'>
            ...
            <div>
                ...
                <select onChange={(e)=> setSubCategory(e.target.value)} className='w-full px-3 py-2'>
                    ...
                    <option value="CoordSets">Co-ord Sets</option>
        ...
        <button className='w-35 py-3 mt-4 bg-black text-white cursor-pointer' type="submit">Add Product</button>
